...
今回ご紹介するスマホが入るロボット、通称smaboは名前の通りスマートフォンが入るロボットです。
...
<fieldset style="padding: 10px; border: 0px solid #f5f67; border-radius: 10px; background: #f5f67; -moz-border-radius: 10px; -webkit-border-radius: 10px;">
<legend><span style="font-size: 18px;  font-weight:bold;">
目次
</span> </legend>
...
https://twitter.com/akinami_robo/status/1719365981439692969
...
<fieldset style="padding: 10px; border: 0px solid #f5f67; border-radius: 10px; background: #f5f67; -moz-border-radius: 10px; -webkit-border-radius: 10px;">
<legend><span style="font-size: 16px;  font-weight:bold;">
記事一覧
</span> </legend>

- 【後日作成予定】smaboのボディを作ってみよう
- 【後日作成予定】（事前準備）ラズパイとros2をインストールしよう
- 【後日作成予定】smaboをROS2で通信してみよう
- 【後日作成予定】smaboに腕を取り付けて制御してみよう
- 【後日作成予定】smaboにカメラと超音波センサを取り付けてみよう
</fieldset>
...
以下が、記事一覧になります
- 【後日作成予定】smaboで画像認識してみよう
- 【後日作成予定】smaboで機械学習してみよう
- 【後日作成予定】smaboで音声認識してみよう
- 【後日作成予定】smaboとマイコンをmicro-ROSで通信してみよう
</fieldset>
...
以下が、記事一覧になります
- （事前準備）ラズパイとノートpcをros2で通信してみよう
- 【後日作成予定】smaboを移動ロボットにしてみよう
- 【後日作成予定】smaboにロボットアームを取り付けてみよう
- 【後日作成予定】smaboを二足歩行ロボットにしてみよう
</fieldset>
...
<fieldset style="padding: 10px; border: 0px solid #fc4a1a; border-radius: 10px; background: #e3f7df; -moz-border-radius: 10px; -webkit-border-radius: 10px;">
<legend><span style="font-size: 18px;  font-weight:bold;">
tips
</span> </legend>
「互換品多数あり」の商品に関しては、もっと安い商品があるかもしれないので、品質とのバランスを考えて互換品の購入も検討してみてください
</fieldset>
...
ピンヘッダがある部品に関しては、初心者の方でも使いやすい「はんだ付け済」の商品のURLを記載しています。<br><br>
ただし、「はんだ付け済み」は値段が高いことが多いので自身ではんだ付けできる方は「はんだ付けされていない」部品を買った方がお得です。
</fieldset>
...
<br>
<br>
具体的なsmaboの作り方については、別記事にて随時、解説してく予定です。<br>
